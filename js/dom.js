...
// h2 headling - text color change by DOM

const textColor = document.getElementById('dom-majik');
...
// Card border-radius change to 10px to 30px
...
document.getElementById('btn-click').addEventListener('click', function(){
    console.log('This is click handler button');
})
...
const buttons = document.getElementsByClassName('item-remove');
...
document.getElementById('exampleInputPassword1').addEventListener('keyup', function(event){
...
document.getElementById('bg-color-change').addEventListener('dblclick', function(){
